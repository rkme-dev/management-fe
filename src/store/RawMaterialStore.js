...
export const RawMaterialStore = {
    ...
    actions: {
        ...
        addUnitPacking({ commit, dispatch }, data) {
            ...
            return rawMaterialService.addUnit(data)
                .then(
                    // eslint-disable-next-line no-shadow
                    response => {
                        if (response.data.id) {
        ...
        removeUnitPacking({ commit, dispatch }, data) {
            ...
            return rawMaterialService.removeUnit(data)
                .then(
                    // eslint-disable-next-line no-shadow
                    response => {
                        if (response.data.id) {
        ...
        delete({ commit, dispatch }, data) {
            ...
            return rawMaterialService.delete(data)
                .then(
                () => {
                    commit('setErrors', {})
        ...
        return rawMaterialService.list().then(
            response => {
                commit('setErrors', {})
        ...
        get({ commit, dispatch }, id) {
            ...
            return rawMaterialService.get(id).then(
                response => {
        ...
        update({ commit, dispatch }, data) {
            ...
            return rawMaterialService.update(data)
                .then(
                    // eslint-disable-next-line no-shadow
                    response => {
                        if (response.data.id) {
