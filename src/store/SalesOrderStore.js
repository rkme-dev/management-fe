...
export const SalesOrderStore = {
  ...
  actions: {
    ...
    create({ commit }, data) {
      ...
      return salesOrderService.create(data)
        .then(
          // eslint-disable-next-line no-shadow
          response => {
            if (response.data.id) {
    ...
    delete({ commit }, data) {
      ...
      return salesOrderService.delete(data)
        .then(
          () => {
    ...
    orderItems({ commit }, customerId) {
      ...
      return salesOrderService.orderItems(customerId).then(
        response => {
    ...
    allOrderItems({ commit }) {
      ...
      return salesOrderService.allOrderItems().then(
        response => {
          commit('fetchOrderItemsSuccess', response.data)
          commit('setLoading', false)
    ...
    list({ commit }) {
      ...
      return salesOrderService.list().then(
        response => {
    ...
    get({ commit }, id) {
      ...
      return salesOrderService.get(id).then(
        response => {
    ...
    update({ commit }, data) {
      ...
      return salesOrderService.update(data)
        .then(
          // eslint-disable-next-line no-shadow
          response => {
            if (response.data.id) {
    ...
    postOrder({ commit }, id) {
      ...
      return salesOrderService.postOrder(id)
        .then(
          // eslint-disable-next-line no-shadow
          response => {
            if (response.data.id) {
    ...
    unpostOrder({ commit }, id) {
      ...
      return salesOrderService.unpostOrder(id)
        .then(
          // eslint-disable-next-line no-shadow
          response => {
            if (response.data.id) {
