    ...
    const fetchOrderItems = items => {
      ...
      for (let index = 0; index < orderItems.value.length; index++) {
        if (orderItems.value[index].area) {
          ...
          formData.value.term_id = orderItems.value[index].term_id
          formData.value.address = orderItems.value[index].address
          formData.value.remarks = orderItems.value[index].remarks
          formData.value.salesman_id_1 = orderItems.value[index].salesman_id_1
          formData.value.salesman_id_2 = orderItems.value[index].salesman_id_2
          formData.value.vat_id = orderItems.value[index].vat_id
          formData.value.promo_code = orderItems.value[index].promo_code
