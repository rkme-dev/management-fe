<template>
  ...
  export default {
    ...
    setup() {
      ...
      const agingTotal = computed(() => store.state.ReportStore.agingReport.reduce((a,b) => { return a + b.total },0));
      const agingItemTotal = computed(() => store.state.ReportStore.agingItemsReport.reduce((a,b) => { return a + b.remaining_balance_num },0));
