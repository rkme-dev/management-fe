...
import FinishProductFormWithForm from '@/views/pages/master-files/finish-products/FinishProductWithUnitForm.vue'
import store from '@/store'

export default {
  name: 'FinishProductListTable',
  components: {
    FinishProductFormWithForm,
  },
  setup() {
    const statusColor = {
      Active: 'success',
    ...
    watch(statusFilter, () => {
      store.dispatch('FinishProductStore/filter', statusFilter.value)
    })
  ...
  computed: {
    ...
    list() {
      return this.$store.state.FinishProductStore.list
    },
    loading() {
      return this.$store.state.FinishProductStore.loading
    },
  },
  ...
  methods: {
    ...
    deleteItemConfirm() {
      ...
      store.dispatch('FinishProductStore/update', this.list[this.editedIndex]).then(
        response => {
