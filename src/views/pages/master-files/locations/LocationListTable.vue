...
import LocationForm from '@/views/pages/master-files/locations/LocationForm.vue'
...
export default {
  ...
  setup() {
    ...
    watch(filter, value => {
      store.dispatch('LocationStore/filter', filter.value)
    })
  ...
  computed: {
    ...
    locations() {
      return this.$store.state.LocationStore.locations
    },
    loading() {
      return this.$store.state.LocationStore.loading
    },
  },
  ...
  created() {
    ...
    this.$store.dispatch('LocationStore/removeErrors')
  },
  methods: {
    ...
    deleteItemConfirm() {
      this.locations[this.editedIndex].is_active = false
      store.dispatch('LocationStore/update', this.locations[this.editedIndex]).then(
        response => {
